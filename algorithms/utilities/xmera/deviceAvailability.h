...
inline DeviceAvailability toDeviceAvailability(const ::FSWdeviceAvailability availability) {
    return availability == AVAILABLE ? DeviceAvailability::Available : DeviceAvailability::Unavailable;
}

inline ::FSWdeviceAvailability toXmeraDeviceAvailability(const DeviceAvailability availability) {
