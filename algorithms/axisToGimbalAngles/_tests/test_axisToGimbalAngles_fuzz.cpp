...
// angle outside that range is not a value that the module can give, and the direction that it builds has a
// deflection of 90 degrees or more. Thus it is not a regression input. This is a property of the two angles.
...
// The direction range includes the origin and all deflections, thus the fuzz test also examines the directions
